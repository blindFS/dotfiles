...
theme.wallpaper_cmd = { "awsetbg /home/farseer/.config/awesome/wallpapers/42.jpg" }

theme.font                                  = "hooge 05_53 8"
theme.taglist_font                          = "monaco for powerline 9"
theme.fg_normal                             = "#889eA5"
theme.fg_focus                              = "#9DFFC2"
...
theme.textbox_widget_as_label_font_color    = red
theme.textbox_widget_margin_top             = 1
theme.text_font_color_1                     = orange
theme.text_font_color_2                     = green
theme.text_font_color_3                     = red
theme.notify_font_color_1                   = green
theme.notify_font_color_2                   = orange
theme.notify_font_color_3                   = red
theme.notify_font_color_4                   = lblue
theme.notify_font                           = "monaco for powerline 9"
theme.notify_fg                             = theme.fg_normal
theme.notify_bg                             = dgrey
theme.notify_border                         = theme.border_focus
theme.awful_widget_bckgrd_color             = dgrey
theme.awful_widget_border_color             = red
